	...
	theme: {
      ...
      fontFamily: {
        ...
        foreground: 'hsl(var(--foreground))', // Uses CSS var
				primary: {
					DEFAULT: 'hsl(var(--primary))', // Uses CSS var
					foreground: 'hsl(var(--primary-foreground))' // Uses CSS var
				},
				secondary: {
					DEFAULT: 'hsl(var(--secondary))', // Uses CSS var
					foreground: 'hsl(var(--secondary-foreground))' // Uses CSS var
				},
				destructive: {
        ...
        neutral: {
          ...
          muted: '#6c757d',  // Lighter text for descriptions
        }
			},
			borderRadius: {
				lg: 'var(--radius)',
